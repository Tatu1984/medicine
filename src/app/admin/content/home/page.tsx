...
export const metadata: Metadata = { title: "Edit Home", robots: { index: false, follow: false } };
  ...
  return (
    <div className="min-h-screen bg-secondary/30">
      ...
      <div className="container-page py-10">
        ...
        <h1 className="mt-4 mb-8 text-2xl font-semibold">The Idea (Home)</h1>
        <HomeEditor defaults={home} />
      </div>
    </div>
  );
}
